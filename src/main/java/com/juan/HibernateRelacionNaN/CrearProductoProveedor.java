...
public class CrearProductoProveedor {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Producto_Proveedor producto_proveedor1 = new Producto_Proveedor(pepino, ana, LocalDate.now());
            Producto_Proveedor producto_proveedor2 = new Producto_Proveedor(endivia, ana, LocalDate.now());
            session.save(producto_proveedor1);
            session.save(producto_proveedor2);
            transaction.commit();
            /*
